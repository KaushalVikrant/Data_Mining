...
pathForAttributes="E:\Semester 2\Data Mining\Assignments\Assignment 3\Data Sets\Abalone\\attributes.txt"
pathForData="E:\Semester 2\Data Mining\Assignments\Assignment 3\Data Sets\Abalone\\abalone.data.txt"
...
minLiftThreshold=1.5             #minimum lift
...
def readAttributesFile(path):
    ...
    for data in f:
        ...
        if not row:
            continue
        for val in row:
            attributeList.append(val.strip())
...
def readFile(path,source):
    ...
    for data in f:
        ...
        #Length
        if float(row[1]) <= 0.524:
            tempList.extend([1,0])
        else:
            tempList.extend([0,1])

        #Diameter
        if float(row[2]) <= 0.408:
            tempList.extend([1,0])
        else:
            tempList.extend([0,1])

        #Height
        if float(row[3]) <= 0.140:
            tempList.extend([1,0])
        else:
            tempList.extend([0,1])
        ...
        #Whole
        if float(row[4]) <= 0.829:
            tempList.extend([1,0])
        else:
            tempList.extend([0,1])

        #Shucked
        if float(row[5]) <= 0.359:
            tempList.extend([1,0])
        else:
            tempList.extend([0,1])

        #Viscera
        if float(row[6]) <= 0.181:
            tempList.extend([1,0])
        else:
            tempList.extend([0,1])

        #Shell weight
        if float(row[7]) <= 0.239:
            tempList.extend([1,0])
        else:
            tempList.extend([0,1])

        #Class
        if int(row[8].strip()) <= 10:
            tempList.extend([1,0,0])
        elif int(row[8].strip()) <= 20:
            tempList.extend([0,1,0])
        else:
            tempList.extend([0,0,1])
